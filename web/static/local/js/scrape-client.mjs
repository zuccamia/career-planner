...
// getServerScraperStatus fetches /api/scrape/server-status once per browser
// session and caches the promise — parallel to getServerLLMStatus in
// llm-client.mjs. Used to decide whether to hint "server also scrapes" on
