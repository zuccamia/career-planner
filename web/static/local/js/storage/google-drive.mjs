// Google Drive backend using a hand-rolled OAuth PKCE flow.
...
//
// Token exchange is proxied through /oauth/google/token so client_secret
// stays server-side.
...
export class GoogleDriveBackend {
  ...
  isReady() { return !!this.refreshToken || !!this.accessToken; }
