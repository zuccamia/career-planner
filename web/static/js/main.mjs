...
import { mountSettings } from './pages/settings/index.mjs';
import { mountApplications } from './pages/applications/index.mjs';
import { mountDashboard } from './pages/dashboard/index.mjs';
import { mountCompanies } from './pages/companies/index.mjs';
import { mountPeople } from './pages/people/index.mjs';
import { mountProfile } from './pages/profile/index.mjs';
