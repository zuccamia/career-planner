...
// Typst compile + preview iframe, PDF download, and attach-to-application action.
// Lifecycle: hidden <section id="resume-panel"> is filled then moved into the fixed overlay by openSlideOver.
