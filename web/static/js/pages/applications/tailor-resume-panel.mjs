...
import { computeATSCoverage, exceedsOnePage, keywordsInText } from '../../clients/tailor/helpers.mjs';
...
const REJECT_REASON_KEYS = new Set([
  'invalid_index', 'empty_or_noop', 'suspicious_text',
]);
