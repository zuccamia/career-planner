...
const WORKER_URL = `${STATIC_ROOT}js/workers/md-extract-worker.mjs`;
...
// extractMarkdown(bytes, { timeoutMs }) → { kind, markdown, warnings }
// bytes must be a Uint8Array. Throws on unsupported format, timeout, or
// parser failure.
export const extractMarkdown = async (bytes, { timeoutMs = DEFAULT_TIMEOUT_MS } = {}) => {
