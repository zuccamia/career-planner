// Ports internal/people/service.go: FinalizeSummary +
...
// buildThreadContext ports internal/people/service.go. Channel and
...
export const build = async (input, locale) =>
  buildFormatted('people/summarize-thread', locale, buildThreadContext(input));
