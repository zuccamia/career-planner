...
// English-locale prompt content for the communications package.

import "github.com/zuccamia/career-planner/internal/sources/llm"

var summarizeEN = llm.Prompt{
...
Do not include markdown.`,
	User: `Update the communication thread summary.
...
var messageEN = llm.Prompt{
	System: `You are a thoughtful outreach assistant for professional networking.
...
Write the message in the same language as the thread content itself. If entries mix languages, use the dominant one.

Return valid JSON only.
Do not include markdown.`,
	User: `Generate exactly one JSON object with this key:
- message
